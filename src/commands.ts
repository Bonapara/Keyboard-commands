...
export const COMMAND_DEFINITIONS = {
  ...
  RadiusExceptTopLeft: {
    ...
    alias: ['-rtl'],
    valueFormat: 'number' as const,
    suggestion: 'Radius in px for all corners except top left (No value = 0)',
    functionWithParam: (value: string) => impl.setRadiusExcept('topLeft', value),
    functionWithoutParam: () => impl.setRadiusExcept('topLeft', '0'),
    supportedNodes: [...NODE_GROUPS.CORNER_RADIUS],
  },
  RadiusExceptTopRight: {
    ...
    alias: ['-rtr'],
    valueFormat: 'number' as const,
    suggestion: 'Radius in px for all corners except top right (No value = 0)',
    functionWithParam: (value: string) => impl.setRadiusExcept('topRight', value),
    functionWithoutParam: () => impl.setRadiusExcept('topRight', '0'),
    supportedNodes: [...NODE_GROUPS.CORNER_RADIUS],
  },
  RadiusExceptBottomRight: {
    ...
    alias: ['-rbr'],
    valueFormat: 'number' as const,
    suggestion: 'Radius in px for all corners except bottom right (No value = 0)',
    functionWithParam: (value: string) => impl.setRadiusExcept('bottomRight', value),
    functionWithoutParam: () => impl.setRadiusExcept('bottomRight', '0'),
    supportedNodes: [...NODE_GROUPS.CORNER_RADIUS],
  },
  RadiusExceptBottomLeft: {
    ...
    alias: ['-rbl'],
    valueFormat: 'number' as const,
    suggestion: 'Radius in px for all corners except bottom left (No value = 0)',
    functionWithParam: (value: string) => impl.setRadiusExcept('bottomLeft', value),
    functionWithoutParam: () => impl.setRadiusExcept('bottomLeft', '0'),
    supportedNodes: [...NODE_GROUPS.CORNER_RADIUS],
  },
  RadiusAll: {
    type: "optionalValueCommand",
