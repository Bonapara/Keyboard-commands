...
export const COMMAND_DEFINITIONS = {
  ...
  AlignTopLeft: {
    ...
    alias: ['atl', 'alt'],
    valueFormat: 'string' as const,
    suggestion: 'Align Top Left ↖ (p = parent)',
  ...
  AlignTopCenter: {
    ...
    alias: ['atc', 'act'],
    valueFormat: 'string' as const,
    suggestion: 'Align Top Center ↑ (p = parent)',
  ...
  AlignTopRight: {
    ...
    alias: ['atr', 'art'],
    valueFormat: 'string' as const,
    suggestion: 'Align Top Right ↗ (p = parent)',
  ...
  AlignCenterLeft: {
    ...
    alias: ['acl', 'alc'],
    valueFormat: 'string' as const,
    suggestion: 'Align Center Left ← (p = parent)',
  ...
  AlignCenterCenter: {
    ...
    alias: ['acc'],
    valueFormat: 'string' as const,
    suggestion: 'Align Center Center ・ (p = parent)',
  ...
  AlignCenterRight: {
    ...
    alias: ['acr', 'arc'],
    valueFormat: 'string' as const,
    suggestion: 'Align Center Right → (p = parent)',
  ...
  AlignBottomLeft: {
    ...
    alias: ['abl', 'alb'],
    valueFormat: 'string' as const,
    suggestion: 'Align Bottom Left ↙ (p = parent)',
  ...
  AlignBottomRight: {
    ...
    alias: ['abr', 'arb'],
    valueFormat: 'string' as const,
    suggestion: 'Align Bottom Right ↘ (p = parent)',
  ...
  AlignBottomCenter: {
    ...
    alias: ['abc', 'acb'],
    valueFormat: 'string' as const,
    suggestion: 'Align Bottom Center ↓ (p = parent)',
